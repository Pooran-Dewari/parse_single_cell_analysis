...
#update subdir
mat <- Read10X(data.dir ="/exports/cmvm/eddie/eb/groups/bean_grp/Pooran/gigas_star_strict/star_outputs_Uni_Mult_Resc_collated/a2_subdir")
...
#update project
seu_obj <- CreateSeuratObject(counts = merge, project = "oyster2")

#update file
saveRDS(seu_obj, file = "seu_obj2.rds")
