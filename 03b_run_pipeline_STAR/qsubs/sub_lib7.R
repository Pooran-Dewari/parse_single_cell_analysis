...
#update subdir
mat <- Read10X(data.dir ="/exports/cmvm/eddie/eb/groups/bean_grp/Pooran/gigas_star_strict/star_outputs_Uni_Mult_Resc_collated/a7_subdir")
...
#update project
seu_obj <- CreateSeuratObject(counts = merge, project = "oyster7")

#update file
saveRDS(seu_obj, file = "seu_obj7.rds")
